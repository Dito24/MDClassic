...
2. run mrclassicd with -printalert or -sendalert like this:
   /path/to/mrclassicd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.mrclassic.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Mrclassic Core:0.12.0.58/"));

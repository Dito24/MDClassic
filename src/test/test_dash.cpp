...
#define BOOST_TEST_MODULE Mrclassic Test Suite

#include "test_mrclassic.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_mrclassic_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

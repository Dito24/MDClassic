    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Mrclassic Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mrclassic address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mrclassic: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Mrclassic Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mrclassic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mrclassic Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mrclassic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mrclassic addresses"));
    ...
    openAction->setStatusTip(tr("Open a mrclassic: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mrclassic Core help message to get a list with possible Mrclassic Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Mrclassic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mrclassic network", "", count));
    } else {
...
{
    QString strTitle = tr("Mrclassic Core"); // default title
    ...
    // Append title to "Mrclassic Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

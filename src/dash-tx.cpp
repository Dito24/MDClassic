...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Mrclassic Core mrclassic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mrclassic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mrclassic transaction") + "\n" +
              "  mrclassic-tx [options] -create [commands]   " + _("Create hex-encoded mrclassic transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mrclassic transaction

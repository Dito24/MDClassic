...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MrclassicNetwork") type = MrclassicNetwork;
    if(strType == "MrclassicNetworkVariable") type = MrclassicNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MrclassicNetwork) s = "MrclassicNetwork";
    if(type == MrclassicNetworkVariable) s = "MrclassicNetworkVariable";

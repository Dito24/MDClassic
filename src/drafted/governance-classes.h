 ...
 *
 *   // network
 *   CMrclassicNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.mrclassic.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMrclassicNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMrclassicNetwork(UniValue objIn)
    {
...
// // can be under: MrclassicNetwork
// //   -- signature requirements : Key1(User)
// class CMrclassicNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == MrclassicNetwork);
//     // }

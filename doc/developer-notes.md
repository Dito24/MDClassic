...
Mrclassic Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Mrclassic Core, where everyone uses
...
pay attention to for reviewers of Mrclassic Core code.

General Mrclassic Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Mrclassic Core uses tinyformat, which is type safe. Leave them out to avoid confusion

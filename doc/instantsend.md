...
This mechanism has been integrated into Bitcore-Node-Mrclassic which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mrclassicpay/insight-api-mrclassic#web-socket-api](https://github.com/mrclassicpay/insight-api-mrclassic#web-socket-api)
* API: [https://github.com/mrclassicpay/insight-api-mrclassic#instantsend-transactions](https://github.com/mrclassicpay/insight-api-mrclassic#instantsend-transactions)
...
By default, the Mrclassic Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mrclassic Core daemon:

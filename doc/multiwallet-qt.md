...
Only requiring some minor changes is mrclassic.cpp.
...
Changes to mrclassic.cpp
----------------------
mrclassic.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
